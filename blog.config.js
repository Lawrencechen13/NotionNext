...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '和丰工作室', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '和丰工作室（Hefengstudio）专注互联网工具应用，欢迎关注🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hfsc.work', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:lawrencechenlei@gmail.com || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO:  '', // 你的微博个人主页
  CONTACT_TWITTER:https://twitter.com/Laurencechenlei'', // 你的twitter个人主页
  CONTACT_GITHUB: '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: https://t.me/kyc1313'', // 你的telegram 地址 例如 https://t.me/tangly_1024
